...
export const PersonCardSkeleton = ({}) => {
  return (
    ...
    >
      <div
        className={classNames(
          `flex items-center justify-center w-96 h-48 bg-gray-300 rounded sm:w-72 dark:bg-gray-700`,
        )}
      >
        <svg
          className={classNames(`w-10 h-10 text-gray-200 dark:text-gray-600`)}
          aria-hidden="true"
